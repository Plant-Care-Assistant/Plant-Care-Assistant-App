...
export const PlantCard: React.FC<PlantCardProps> = ({
  ...
  return (
    ...
    >
      {/* Plant Image */}
      <div
        className={`w-full h-40 lg:h-48 relative ${
      ...
      >
        {imageUrl ? (
          ...
          <div className="w-full h-full flex items-center justify-center">
            <Droplets
              size={48}
              className={darkMode ? "text-neutral-600" : "text-neutral-300"}
            />
          </div>
        )}
      ...
      <div className="p-4">
        <h3
          className={`font-bold text-base lg:text-lg mb-1 truncate ${
        ...
        {species && (
          <p
            className={`text-xs mb-3 opacity-70 truncate ${
