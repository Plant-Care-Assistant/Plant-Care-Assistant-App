...
import {
  CollectionFilters,
  FilterOption,
} from "@/components/features/collection/CollectionFilters";
import { PlantCard } from "@/components/features/collection/PlantCard";
import {
  AddPlantModal,
  type PlantFormData,
} from "@/components/features/collection/AddPlantModal";
import { Plus } from "lucide-react";
import { filterAndSearchPlants, type Plant } from "@/lib/utils/plantFilters";
import { usePlantsQuery, useAddPlantMutation } from "@/hooks/usePlants";
...
export function CollectionScreen({ darkMode }: CollectionScreenProps) {
  ...
  const handlePlantClick = (plantId: string | number) => {
